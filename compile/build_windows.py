...
def main():
    ...
    if os.name == 'nt':
        ...
        subprocess.run([sys.executable, "-m", "pip", "install", "pyinstaller", "customtkinter==5.2.2", "pillow", "rich"], check=False)
        ...
        docker_command = (
            "wine python -m pip install pyinstaller customtkinter==5.2.2 pillow rich && "
