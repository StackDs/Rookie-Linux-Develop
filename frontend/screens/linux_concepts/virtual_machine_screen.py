...
class VirtualMachineScreen(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.title = ctk.CTkLabel(self, text="> Máquinas Virtuales_", 
                                  text_color="#00FF00",
        ...
        vm_title = ctk.CTkLabel(content_frame, text=">_ ¿Qué es una Máquina Virtual?", text_color="#00E676", font=ctk.CTkFont(family="Consolas", size=20, weight="bold"))
        vm_title.pack(anchor="w", pady=(10, 5))
        
        vm_text = (
            "Una Máquina Virtual (VM) es un software que simula un sistema informático completo. "
            "Funciona como una 'computadora dentro de tu computadora'. Te permite instalar y ejecutar Linux, "
            "o cualquier otro sistema operativo, en una ventana como si fuera un programa más dentro de Windows.\n\n"
            "Es una forma muy segura de probar sistemas nuevos sin riesgo de afectar tu instalación principal. "
        ...
        self.btn_volver = ctk.CTkButton(btn_frame, text="←    Volver", command=lambda: self.controller.show_frame("BasicConceptsScreen"),
        ...
        self.btn_siguiente = ctk.CTkButton(btn_frame, text="Siguiente    →", command=lambda: self.controller.show_frame("CleanInstallationScreen"),
                                       height=45, width=220, corner_radius=5,
                                       font=ctk.CTkFont(family="Consolas", size=15, weight="bold"), cursor="hand2",
                                       fg_color="transparent", border_width=2, border_color="#008800",
                                       hover_color="#001100", text_color="#008800")
