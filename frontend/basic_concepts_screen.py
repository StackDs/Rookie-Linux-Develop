...
class BasicConceptsScreen(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.title = ctk.CTkLabel(self, text="> Dual Boot_", 
                                  text_color="#00FF00",
        ...
        # Dual boot section
        db_title = ctk.CTkLabel(content_frame, text=">_ ¿Qué es el Dual Boot?", text_color="#00E676", font=ctk.CTkFont(family="Consolas", size=20, weight="bold"))
        db_title.pack(anchor="w", pady=(10, 5))
        
        db_text = (
            "El 'Dual Boot' (arranque dual) es una configuración que permite instalar dos sistemas operativos "
            "diferentes (como Windows y Linux) en la misma computadora. Al encender el equipo, un menú te "
            "preguntará cuál sistema deseas iniciar. Esto es ideal para probar Linux sin perder tus programas y "
            "juegos de Windows.\n\n"
        ...
        self.btn_volver = ctk.CTkButton(btn_frame, text="←    Volver", command=lambda: self.controller.show_frame("ExplanationScreen"),
